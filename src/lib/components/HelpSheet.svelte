...
<dialog bind:this={dialog} class="help-sheet" aria-labelledby="help-title" oncancel={(event) => { event.preventDefault(); close(); }}>
	...
	<p class="emergency-boundary"><Icon name="shield" size={24} /><span><strong>CareWeave is not an emergency monitoring service.</strong> It cannot detect a fall, illness, or whether someone is safe.</span></p>
	<div class="help-actions">
		...
		<a class="emergency-call" href="tel:112"><Icon name="emergency" size={22} /> Call emergency services: 112</a>
	</div>
